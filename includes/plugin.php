...
final class Plugin {
	...
	public function i18n() {
		load_plugin_textdomain( 'elementor-custom-addon' );
	}
	...
	public function add_elementor_widget_categories( $elements_manager ) {
		...
		$elements_manager->add_category(
			'elementor_custom_addon_category',
			[
				'title' => __( 'ECA Custom Widgets', 'elementor-custom-addon' ),
				'icon' => 'eicon-nerd'
			]
		);
	}
	...
	public function register_controls( $controls_manager ) {
		...
		/* controls_manager->register( nedw Control_1() ); */
